...
[ExerciseTestFixture("dotNet1", "H06", "Exercise10", @"Exercise10\MainWindow.xaml;Exercise10\MainWindow.xaml.cs")]
...
public class MainWindowTests
{
    ...
    public void Setup()
    {
        ...
        _hasErrorLabel = allLabels.Any(l => l.Name.Contains("errorLabel"));
    ...
    public void _1_ShouldHaveLabels()
    {
        ...
        Assert.That(_hasErrorLabel, Is.True, () => "No Label found with name 'errorLabel' to show error message");
    }
